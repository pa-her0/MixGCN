        ...
        for l in range(layers):
            ...
            if is_last:
                ...
                layer = GATLayer(
                    ...
                    feat_dropout=dropout, attn_dropout=attn_dropout,
                    activation=activation or nn.PReLU(), leaky_slope=leaky_slope
                )
            mods.append(layer)
...
def main():
    ...
    summary_csv = os.path.join(args.outdir, f"summary_{ds_name}_GAT_PRELU.csv")
    curves_csv = os.path.join(args.outdir, f"curves_{ds_name}_GAT_PRELU.csv")
