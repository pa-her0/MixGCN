...
class BaseLayer(nn.Module):
    def __init__(self, in_dim, out_dim, *, conv_kind='gcn', heads=1, concat=True,
        ...
        # ✅ 默认使用 PReLU 激活函数（可学习参数）
        self.activation = activation or nn.PReLU()
    ...
    def __init__(self, in_dim, hidden, out_dim, *,
        ...
        for l in range(layers - 1):
            layer = BaseLayer(cur_in, hidden, conv_kind=conv_kind,
                              ...
                              leaky_slope=leaky_slope, activation=activation or nn.PReLU())
...
def main():
    ...
    summary_csv = os.path.join(args.outdir, f"summary_{ds_name}_PRELU.csv")
    curves_csv = os.path.join(args.outdir, f"curves_{ds_name}_PRELU.csv")
